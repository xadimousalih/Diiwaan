...
import sn.tab28.diwanou.quranya6.utils.ActionItem;
import sn.tab28.diwanou.quranya6.utils.QuickAction;
import sn.tab28.diwanou.quranya6.utils.UnzipUtil;
...
public class HomeActivity extends DashBoardActivity {
	...
	QuickAction jukky1, jukky2, jukky3, jukky4, jukky5;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (ifExistFile(path)) {
			...
			jukky1.setOnActionItemClickListener(new QuickAction.OnActionItemClickListener() {
				...
				public void onItemClick(QuickAction source, int pos,
					...
					if (actionId == ID_PART1) {
						...
						pdfURL = "http://www.daaraykamil.com/app_files/diwan6/diwan6_1.pdf";
			...
			jukky2.setOnActionItemClickListener(new QuickAction.OnActionItemClickListener() {
				...
				public void onItemClick(QuickAction source, int pos,
					...
					if (actionId == ID_PART3) {
						...
						pdfURL = "http://www.daaraykamil.com/app_files/diwan6/diwan6_2.pdf";
						pdfAction(getFileName(pdfURL));
					} else if (actionId == ID_PART4) {
						jukky2.dismiss();

						pdfURL = "http://www.daaraykamil.com/app_files/diwan6/diwan6_3.pdf";
						pdfAction(getFileName(pdfURL));
					} else {
						Toast.makeText(
								getApplicationContext(),
			...
			jukky3.setOnActionItemClickListener(new QuickAction.OnActionItemClickListener() {
				...
				public void onItemClick(QuickAction source, int pos,
					...
					if (actionId == ID_PART5) {
						...
						pdfURL = "http://www.daaraykamil.com/app_files/diwan6/diwan6_4.pdf";
						pdfAction(getFileName(pdfURL));
					} else if (actionId == ID_PART6) {
						jukky3.dismiss();

						pdfURL = "http://www.daaraykamil.com/app_files/diwan6/diwan6_5.pdf";
						pdfAction(getFileName(pdfURL));
					} else {
						Toast.makeText(
								getApplicationContext(),
			...
			jukky4.setOnActionItemClickListener(new QuickAction.OnActionItemClickListener() {
				...
				public void onItemClick(QuickAction source, int pos,
					...
					if (actionId == ID_PART7) {
						...
						pdfURL = "http://www.daaraykamil.com/app_files/diwan6/diwan6_6.pdf";
						pdfAction(getFileName(pdfURL));
					} else if (actionId == ID_PART8) {
						jukky4.dismiss();
						pdfURL = "http://www.daaraykamil.com/app_files/diwan6/diwan6_7.pdf";
						pdfAction(getFileName(pdfURL));
					} else {
						Toast.makeText(
								getApplicationContext(),
			...
			jukky5.setOnActionItemClickListener(new QuickAction.OnActionItemClickListener() {
				...
				public void onItemClick(QuickAction source, int pos,
					...
					if (actionId == ID_PART9) {
						...
						pdfURL = "http://www.daaraykamil.com/app_files/diwan6/diwan6_8.pdf";
						pdfAction(getFileName(pdfURL));
					} else if (actionId == ID_PART10) {
						jukky5.dismiss();
						pdfURL = "http://www.daaraykamil.com/app_files/diwan6/diwan6_9.pdf";
						pdfAction(getFileName(pdfURL));
					} else {
						Toast.makeText(
								getApplicationContext(),
			...
			File file = new File(Environment.getExternalStorageDirectory()
					+ File.separator + "diwanouquranya" + File.separator
					+ "diwan6" + File.separator + "unzipok.out");
						...
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
								...
								if (isOnline()) {
									...
									mew.execute("http://www.daaraykamil.com/app_files/diwan6.zip");
