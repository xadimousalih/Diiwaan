package sn.tab28.diwanou.quranya2;
...
import sn.tab28.diwanou.quranya2.utils.ActionItem;
import sn.tab28.diwanou.quranya2.utils.QuickAction;
import sn.tab28.diwanou.quranya2.utils.UnzipUtil;
...
public class HomeActivity extends DashBoardActivity {
	...
	QuickAction jukky1, jukky2, jukky3, jukky4, jukky5, jukky6;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (ifExistFile(path)) {
			...
			jukky1.setOnActionItemClickListener(new QuickAction.OnActionItemClickListener() {
				...
				public void onItemClick(QuickAction source, int pos,
					...
					if (actionId == ID_PART1) {
						...
						pdfURL = "http://www.daaraykamil.com/app_files/diwan2/diwan2_1.pdf";
			...
			jukky2.setOnActionItemClickListener(new QuickAction.OnActionItemClickListener() {
				...
				public void onItemClick(QuickAction source, int pos,
					...
					if (actionId == ID_PART3) {
						...
						pdfURL = "http://www.daaraykamil.com/app_files/diwan2/diwan2_2.pdf";
						pdfAction(getFileName(pdfURL));
					} else if (actionId == ID_PART4) {
						jukky2.dismiss();

						pdfURL = "http://www.daaraykamil.com/app_files/diwan2/diwan2_3.pdf";
						pdfAction(getFileName(pdfURL));
					} else {
						Toast.makeText(
								getApplicationContext(),
			...
			jukky3.setOnActionItemClickListener(new QuickAction.OnActionItemClickListener() {
				...
				public void onItemClick(QuickAction source, int pos,
					...
					if (actionId == ID_PART5) {
						...
						pdfURL = "http://www.daaraykamil.com/app_files/diwan2/diwan2_4.pdf";
						pdfAction(getFileName(pdfURL));
					} else if (actionId == ID_PART6) {
						jukky3.dismiss();

						pdfURL = "http://www.daaraykamil.com/app_files/diwan2/diwan2_5.pdf";
						pdfAction(getFileName(pdfURL));
					} else {
						Toast.makeText(
								getApplicationContext(),
			...
			jukky4.setOnActionItemClickListener(new QuickAction.OnActionItemClickListener() {
				...
				public void onItemClick(QuickAction source, int pos,
					...
					if (actionId == ID_PART7) {
						...
						pdfURL = "http://www.daaraykamil.com/app_files/diwan2/diwan2_6.pdf";
						pdfAction(getFileName(pdfURL));
					} else if (actionId == ID_PART8) {
						jukky4.dismiss();
						pdfURL = "http://www.daaraykamil.com/app_files/diwan2/diwan2_7.pdf";
						pdfAction(getFileName(pdfURL));
					} else {
						Toast.makeText(
								getApplicationContext(),
			...
			jukky5.setOnActionItemClickListener(new QuickAction.OnActionItemClickListener() {
				...
				public void onItemClick(QuickAction source, int pos,
					...
					if (actionId == ID_PART9) {
						...
						pdfURL = "http://www.daaraykamil.com/app_files/diwan2/diwan2_8.pdf";
						pdfAction(getFileName(pdfURL));
					} else if (actionId == ID_PART10) {
						jukky5.dismiss();
						pdfURL = "http://www.daaraykamil.com/app_files/diwan2/diwan2_9.pdf";
						pdfAction(getFileName(pdfURL));
					} else {
						Toast.makeText(
								getApplicationContext(),
			...
			jukky6.addActionItem(part13Item);
			jukky6.setOnActionItemClickListener(new QuickAction.OnActionItemClickListener() {
				...
				public void onItemClick(QuickAction source, int pos,
					...
					if (actionId == ID_PART11) {
						...
						pdfURL = "http://www.daaraykamil.com/app_files/diwan2/diwan2_10.pdf";
						pdfAction(getFileName(pdfURL));
					} else if (actionId == ID_PART12) {
						jukky6.dismiss();
						pdfURL = "http://www.daaraykamil.com/app_files/diwan2/diwan2_11.pdf";
						pdfAction(getFileName(pdfURL));
					} else if (actionId == ID_PART13) {
						jukky6.dismiss();
						pdfURL = "http://www.daaraykamil.com/app_files/diwan2/diwan2_12.pdf";
						pdfAction(getFileName(pdfURL));
					} else {
						Toast.makeText(
								getApplicationContext(),
			...
			File file = new File(Environment.getExternalStorageDirectory()
					+ File.separator + "diwanouquranya" + File.separator
					+ "diwan2" + File.separator + "unzipok.out");
						...
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
								...
								if (isOnline()) {
									...
									mew.execute("http://www.daaraykamil.com/app_files/diwan2.zip");
