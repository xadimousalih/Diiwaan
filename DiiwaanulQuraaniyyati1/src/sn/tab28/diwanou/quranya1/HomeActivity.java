...
import sn.tab28.diwanou.quranya1.utils.ActionItem;
import sn.tab28.diwanou.quranya1.utils.QuickAction;
import sn.tab28.diwanou.quranya1.utils.UnzipUtil;
...
public class HomeActivity extends DashBoardActivity {
	...
	String zipFile = Environment.getExternalStorageDirectory()
			+ "/diwanouquranya/" + "diwan1.zip";
	static File root = Environment.getExternalStorageDirectory();
	static String mypath = root.getAbsolutePath() + "/diwanouquranya/"
			+ "diwan1/";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (ifExistFile(path)) {
			...
			jukky1.setOnActionItemClickListener(new QuickAction.OnActionItemClickListener() {
				...
				public void onItemClick(QuickAction source, int pos,
					...
					if (actionId == ID_PART1) {
						...
						pdfURL = "http://www.daaraykamil.com/app_files/diwan1/diwan1_1_opt.pdf";
			...
			jukky2.setOnActionItemClickListener(new QuickAction.OnActionItemClickListener() {
				...
				public void onItemClick(QuickAction source, int pos,
					...
					if (actionId == ID_PART3) {
						...
						pdfURL = "http://www.daaraykamil.com/app_files/diwan1/diwan1_2_opt.pdf";
						pdfAction(getFileName(pdfURL));
					} else if (actionId == ID_PART4) {
						jukky2.dismiss();

						pdfURL = "http://www.daaraykamil.com/app_files/diwan1/diwan1_3_opt.pdf";
						pdfAction(getFileName(pdfURL));
					} else {
						Toast.makeText(
								getApplicationContext(),
			...
			jukky3.setOnActionItemClickListener(new QuickAction.OnActionItemClickListener() {
				...
				public void onItemClick(QuickAction source, int pos,
					...
					if (actionId == ID_PART5) {
						...
						pdfURL = "http://www.daaraykamil.com/app_files/diwan1/diwan1_4_opt.pdf";
						pdfAction(getFileName(pdfURL));
					} else if (actionId == ID_PART6) {
						jukky3.dismiss();

						pdfURL = "http://www.daaraykamil.com/app_files/diwan1/diwan1_5_opt.pdf";
						pdfAction(getFileName(pdfURL));
					} else {
						Toast.makeText(
								getApplicationContext(),
			...
			jukky4.setOnActionItemClickListener(new QuickAction.OnActionItemClickListener() {
				...
				public void onItemClick(QuickAction source, int pos,
					...
					if (actionId == ID_PART7) {
						...
						pdfURL = "http://www.daaraykamil.com/app_files/diwan1/diwan1_6_opt.pdf";
						pdfAction(getFileName(pdfURL));
					} else if (actionId == ID_PART8) {
						jukky4.dismiss();
						pdfURL = "http://www.daaraykamil.com/app_files/diwan1/diwan1_7_opt.pdf";
						pdfAction(getFileName(pdfURL));
					} else {
						Toast.makeText(
								getApplicationContext(),
			...
			jukky5.setOnActionItemClickListener(new QuickAction.OnActionItemClickListener() {
				...
				public void onItemClick(QuickAction source, int pos,
					...
					if (actionId == ID_PART9) {
						...
						pdfURL = "http://www.daaraykamil.com/app_files/diwan1/diwan1_8_opt.pdf";
						pdfAction(getFileName(pdfURL));
					} else if (actionId == ID_PART10) {
						jukky5.dismiss();
						pdfURL = "http://www.daaraykamil.com/app_files/diwan1/diwan1_9_opt.pdf";
						pdfAction(getFileName(pdfURL));
					} else {
						Toast.makeText(
								getApplicationContext(),
			...
			jukky6.setOnActionItemClickListener(new QuickAction.OnActionItemClickListener() {
				...
				public void onItemClick(QuickAction source, int pos,
					...
					if (actionId == ID_PART11) {
						...
						pdfURL = "http://www.daaraykamil.com/app_files/diwan1/diwan1_10_opt.pdf";
						pdfAction(getFileName(pdfURL));
					} else if (actionId == ID_PART12) {
						jukky5.dismiss();
						pdfURL = "http://www.daaraykamil.com/app_files/diwan1/diwan1_11_opt.pdf";
						pdfAction(getFileName(pdfURL));
					} else {
						Toast.makeText(
								getApplicationContext(),
			...
			File file = new File(Environment.getExternalStorageDirectory()
					...
					+ "diwan1" + File.separator + "unzipok.out");
						...
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
								...
								if (isOnline()) {
									...
									mew.execute("http://www.daaraykamil.com/app_files/diwan1.zip");
			...
			if (result.equalsIgnoreCase("true")) {
				try {
					...
					if (!Environment.getExternalStorageState().equals(
						 ...
						 * File.separator + "diwanouquranya" + File.separator +
						 * "diwan1.zip"); if (file.exists()) { boolean deleted =
						 * file.delete(); Log.d("File Deleted", "" + deleted); }
						 */
						File file = new File(
								Environment.getExternalStorageDirectory()
										+ File.separator + "diwanouquranya"
										+ File.separator + "diwan1"
